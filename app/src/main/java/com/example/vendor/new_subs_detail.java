...
public class new_subs_detail extends AppCompatActivity {
    ...
    public  static String tempdata_;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_new_subs_detail);
...
//
        ...
        remove_ly.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                getSupportFragmentManager().beginTransaction().replace(R.id.frag, new new_sub_removeditems_frag()).commit();
